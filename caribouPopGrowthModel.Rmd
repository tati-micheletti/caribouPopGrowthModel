...
birdsFireCaribouV2 <- readRDS(file = file.path("/mnt/data/Micheletti/NWT", "outputs/birdsFireCaribouV2_11MAR19.rds"))
modules <- list("caribouPopGrowthModel")
objects <- list(cohortData = birdsFireCaribouV2$cohortData,
                pixelGroupMap = birdsFireCaribouV2$pixelGroupMap)
inputs <- list()
outputs <- list()
