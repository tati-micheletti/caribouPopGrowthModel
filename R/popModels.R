...
mortF <- (1-SadF)*100
# newL <- round((1-mortF)/(1-(recr/2)), 2) # basic McLaughlin et al. 2003 lambda model, also used in Sorrensen et al. 2006 # THIS IS WRONG BECAUSE mortF & REC are IN PERCENTAGE
